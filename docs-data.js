...
const docsData = [
    ...
    },
    {
        ...
        "content": [
            ...
            {
                "type": "text",
                "text": "Deploy interactive support panels where members click to open private ticket channels. Staff members can claim tickets, set priority levels, post internal notes, and close tickets from Discord or the dashboard with database-backed duplicate-close protection, transcript logging, optional transcript DMs, stored transcript fallback, and channel cleanup."
            },
            {
                "type": "commands",
                "title": "Commands Reference",
